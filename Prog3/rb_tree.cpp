...
//this is the default constructor whihc will inital all the elements
node :: node()
{
    left = NULL;
    right = NULL;
...
//this is the copy constructor which will copy the element from a 
//passed in object
...
//this is the destructor which is not useful since the base class's
//destructor will work
node :: ~node()
{}

//this is the function to get left pointer of a tree node
node *& node :: go_left()
{
    return this->left;
}

//this si the function to get right pointer of a tree node
node *& node :: go_right()
{
    return this->right;
}

//this is the function to get node's pointer to parent
node *& node :: get_parent()
{
    return this->parent;
}

//this function can help build the tree by set left pointer by passed in pointer
void node :: set_left(node * to_set)
{
    this->left = to_set;
}

//this function can help build the tree by set right pointer by passed in pointer
void node :: set_right(node * to_set)
{
    this->right = to_set;
}

//this function can help build the tree by set parent pointer by passed in pointer
void node :: set_parent(node * to_set)
{
    this->parent = to_set;
}

//This function is used to modify the color
void node :: set_color(bool to_set)
{
    this->color = to_set;
}

//this function is usde to check the color
...
//this is the default constructor to inital all the elements
rb_tree :: rb_tree()
{
    root = NULL;
}
...
//this is the insert function to get passed in reference and insert
...
//this is the balancing function to perform after insert to balance hte tree
...
//this is one case of self balanceing perfomance 
...
//this is the another case of self balacning performance
...
//this is the research function and will return pointer ot node class
...
//this is the recursive research functon
...
//this si the particular display function
...
//this is the recusive part of the display function
...
//this is the function to display all the informaiton in the tree
...
//this is recursive part of the display all function
...
//this is function of the deallocating memory which will help destructor
...
//this is the recursive part of the remove_all function
...
//this is the operation overloading about +=
